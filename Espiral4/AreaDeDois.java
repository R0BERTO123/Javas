...
public class AreaDeDois {
    public static void main(String[] args) {
        ...
        double area1 = Area(base1, altura1);  //AreaRetangulo.Area(base1, altura1);
        double area2 = Area(base2, altura2);  //AreaRetangulo.Area(base2, altura2);

        System.out.printf("A área com dimensão (%.0fx%.0f) é %.0f\n",base1,altura1,area1);

        System.out.printf("A área com dimensão (%.0fx%.0f) é %.0f",base2,altura2,area2);
    }
